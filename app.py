...
http :5000/api/users name="Alice Caroll" email="alice@foo.com" nickname="alice"

http :5000/api/users name="Bob Morane" email="bob@foo.com" nickname="bob"
